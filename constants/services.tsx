export const services = [
  ...
  },
  {
    ...
    description:
      'Master English with personalized lessons tailored to your goals. Whether for professional growth or personal enrichment, I make learning dynamic, effective, and enjoyable. top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8top-0 left-0 w-full z-50 bg-accent-default shadow-lg backdrop-blur-md py-4 xl:py-8',
